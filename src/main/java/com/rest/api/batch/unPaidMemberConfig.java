...
public class unPaidMemberConfig {
    ...
    @Bean
    public Job unPaidMemberJob(JobBuilderFactory jobBuilderFactory, Step unPaidMemberJobStep) {
    ...
    public ListItemReader<Member> unPaidMemberReader() {
        ...
        List<Member> activeMembers = memberRepository.findByStatusEquals(Member.MemberStatus.ACTIVE);
